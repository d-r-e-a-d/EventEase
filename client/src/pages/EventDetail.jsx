    ...
    const handleBooking = async () => {
        ...
        try {
            if (!showOTP) {
                ...
                await api.post('/bookings', { eventId: event._id, seats: Number(seats), otp });
                        ...
                        {!showOTP && (
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    value={seats}
                                    onChange={(e) => setSeats(Math.max(1, Math.min(event.availableSeats, Number(e.target.value) || 1)))}
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-gray-700 transition shadow-sm"
                                />
                            </div>
                        )}
